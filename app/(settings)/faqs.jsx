...
const FAQsPage = () => {
  const faqData = [
    ...
    { question: 'What is the 14-day guided path all about?', answer: 'You can now start multiple guided paths based on 6 main domains of general living. These paths present you with a new question each day to inspire reflection, planning, thinking and more. The main purpose of the path is to give you greater clarity about the domain you are working on while equipping you with the skills to tackle them effectively.' },
    { question: 'How do I connect to get help or support?', answer: 'You can either use the feedback form on the settings page or contact us here: coping.ai.app@gmail.com' },
    ...
    { question: 'I do not like something about Coping, what can I do?', answer: 'Coping is a young app and we are actively looking to improve based on your feedbacks. Please use the feedback section and we will try our best to include your suggestions as soon as possible.'},
    ...
    { question: 'What is counted in the Words Written counter on the homepage?', answer: 'Words Written counts the words you write in your entry along with any words you write as a part of a response with the AI.'},
